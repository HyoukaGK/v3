...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=+5544999862424:+55 (44) 99986-2424\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
*Tem que usar esse simbolo '|' pra separar nome de idade*.`,
			...
			const ownerNumber = ["5544999862424@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '554499862424@s.whatsapp.net'
                        /******ApiKey Input******/
       ...
       case 'regurus':
		client.sendMessage(from, regurus(prefix, sender), text, {quoted: mek})
				break
			case 'timer':
